...
const textBubbles: TextBubble[] = [
  ...
  {
    text: 'Data sourced from bitcoin-dev mailing list, Bitcointalk, Lightning dev mailing list, Bitcoin StackExchange, Bitcoin Optech, & BTC Transcripts',
    type: 'about',
  },
  ...
  return (
    <Box p={2}>
      <Text
        ...
        color="gray.400"
      >
        Explore & learn technical bitcoin concepts and their history
      </Text>
      <Grid
